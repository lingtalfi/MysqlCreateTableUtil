...
Column::getOnUpdate — Returns the onUpdate of this instance.
...
Previous method: [getOnDelete](https://github.com/lingtalfi/MysqlCreateTableUtil/blob/master/doc/api/Ling/MysqlCreateTableUtil/Column/Column/getOnDelete.md)<br>
